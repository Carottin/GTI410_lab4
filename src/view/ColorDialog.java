...
public class ColorDialog extends JDialog {
	...
	private JPanel createCMYKPanel(ColorDialogResult result, int imageWidths) {	
		...
		panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS));
		ColorSlider csCyan = new ColorSlider("C:", (int)cmykMediator.rgbToCmyk(result.getPixel().getRed(),result.getPixel().getGreen(),result.getPixel().getBlue(),"cyan"), cmykMediator.getCyanImage());
		ColorSlider csMagenta = new ColorSlider("M:", (int)cmykMediator.rgbToCmyk(result.getPixel().getRed(),result.getPixel().getGreen(),result.getPixel().getBlue(),"magenta"), cmykMediator.getMagentaImage());
		ColorSlider csYellow = new ColorSlider("Y:", (int)cmykMediator.rgbToCmyk(result.getPixel().getRed(),result.getPixel().getGreen(),result.getPixel().getBlue(),"yellow"), cmykMediator.getYellowImage());
		ColorSlider csBlack = new ColorSlider("K:", (int)cmykMediator.rgbToCmyk(result.getPixel().getRed(),result.getPixel().getGreen(),result.getPixel().getBlue(),"black"), cmykMediator.getBlackImage());
		csBlack.setValue(255);
	...
	private JPanel createHSVPanel(ColorDialogResult result, int imageWidths) {	
		...
		panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS));
		ColorSlider csHue = new ColorSlider("H:", (int)hsvMediator.HSVByRGB(result.getPixel().getRed(),result.getPixel().getGreen(),result.getPixel().getBlue(),"hue"), hsvMediator.getHueImage());
		ColorSlider csSat = new ColorSlider("S:", (int)hsvMediator.HSVByRGB(result.getPixel().getRed(),result.getPixel().getGreen(),result.getPixel().getBlue(),"sat"), hsvMediator.getSatImage());
		ColorSlider csVal = new ColorSlider("V:", (int)hsvMediator.HSVByRGB(result.getPixel().getRed(),result.getPixel().getGreen(),result.getPixel().getBlue(),"val"), hsvMediator.getValImage());
		hsvMediator.setHueCS(csHue);
		hsvMediator.setSatCS(csSat);
		hsvMediator.setValCS(csVal);
	...
	private JPanel createYCbCrPanel(ColorDialogResult result, int imageWidths) {	
		...
		panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS));
		ColorSlider csY = new ColorSlider("Y:", (int)ycbcrMediator.rgbToYCbCr(result.getPixel().getRed(),result.getPixel().getGreen(),result.getPixel().getBlue(),"y"), ycbcrMediator.getYImage());
		ColorSlider csCb = new ColorSlider("Cb:", (int)ycbcrMediator.rgbToYCbCr(result.getPixel().getRed(),result.getPixel().getGreen(),result.getPixel().getBlue(),"cb"), ycbcrMediator.getCbImage());
		ColorSlider csCr = new ColorSlider("Cr:", (int)ycbcrMediator.rgbToYCbCr(result.getPixel().getRed(),result.getPixel().getGreen(),result.getPixel().getBlue(),"cr"), ycbcrMediator.getCrImage());
