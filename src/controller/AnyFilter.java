...
public class AnyFilter extends Filter {	
	 ...
	 */
	public AnyFilter(PaddingStrategy paddingStrategy, 
						 ImageConversionStrategy conversionStrategy,float a,float b,float c,float d,float e,float f,float g,float h,float i) {
	...
	public void SetValue(int column, int line, float value) {
		filterMatrix[column][line]=value;
	}
